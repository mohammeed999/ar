(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_dashboard_statistics_page_tsx_543c964e._.js", {

"[project]/src/app/dashboard/statistics/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
                ...
                "StatisticsPage.useEffect.fetchStatistics": async ()=>{
                    ...
                    if (period === 'week') {
                        ...
                        labels = Array.from({
                            ...
                            "StatisticsPage.useEffect.fetchStatistics": (_, i)=>`${i + 1}`
                        }["StatisticsPage.useEffect.fetchStatistics"]);
                        earningsValues = Array.from({
                            length: 30
                        }, {
                            "StatisticsPage.useEffect.fetchStatistics": ()=>Math.floor(Math.random() * 200) + 100
                        }["StatisticsPage.useEffect.fetchStatistics"]);
                        ordersValues = Array.from({
                            length: 30
                        }, {
                            "StatisticsPage.useEffect.fetchStatistics": ()=>Math.floor(Math.random() * 3) + 1
                        }["StatisticsPage.useEffect.fetchStatistics"]);
                    } else if (period === 'year') {
                        labels = [
                            'يناير',
                    ...
                    }["StatisticsPage.useEffect.fetchStatistics"], 1000);
                }
            }["StatisticsPage.useEffect.fetchStatistics"];
            fetchStatistics();
        }
...
_s(StatisticsPage, "0I+Wf1Us0aytWGhWNcCsIXL8x34=", false, function() {
    return [
...
//# sourceMappingURL=src_app_dashboard_statistics_page_tsx_543c964e._.js.map