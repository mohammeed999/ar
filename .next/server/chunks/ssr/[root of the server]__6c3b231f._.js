    ...
    const login = async (email, password)=>{
        ...
        try {
            ...
            const userData = {
                ...
                role,
                isVerified: true,
                avatar: role === 'admin' ? '/images/avatars/admin-avatar.jpg' : role === 'provider' ? '/images/avatars/provider-avatar.jpg' : '/images/avatars/client-avatar.jpg'
            };
            // حفظ بيانات المستخدم
            setUser(userData);
    ...
    const signup = async (name, email, password, role)=>{
        ...
        try {
            ...
            const userData = {
                ...
                role,
                isVerified: false,
                avatar: role === 'provider' ? '/images/avatars/provider-avatar.jpg' : '/images/avatars/client-avatar.jpg'
            };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6c3b231f._.js.map